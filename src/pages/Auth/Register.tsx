        ...
        <FadeInSection>
          <div className="text-center mb-12 max-w-3xl mx-auto">
            ...
            <div className="text-gray-600 text-left space-y-4">
              <p>
                When you Purchase our CSi Labs Cancer Killing MEME Coins you are Contributing to the "FIGHT Against Cancers" You will also receive a "Limited Time Free Membership & Perks" in the 1-Million Strong Killing Cancers Fight Club!
              </p>
              <p>
                Your contribution supports our 1-Million Strong Killing Cancers Foundation (applying for 501(c)(3) status) to revolutionize cancer research through innovative solutions and bring our Harvard Award Winning Low-cost Cancer Killing Drugs through the FDA so Doctors can write prescriptions Nationwide!
              </p>
            </div>
          </div>
        </FadeInSection>
