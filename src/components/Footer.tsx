...
const ThreadsIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M15.5 9c-.83 0-1.5.67-1.5 1.5 0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5c0-.83-.67-1.5-1.5-1.5zm-7 0C7.67 9 7 9.67 7 10.5S7.67 12 8.5 12 10 11.33 10 10.5 9.33 9 8.5 9zm3.5 3.5c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3zm0 4.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/>
  </svg>
);
