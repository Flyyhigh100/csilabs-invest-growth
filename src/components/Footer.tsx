...
const ThreadsIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path d="M12.186 8.624c-2.289.42-3.948 2.455-3.948 4.882 0 2.657 2.157 4.814 4.814 4.814 2.657 0 4.814-2.157 4.814-4.814 0-2.427-1.659-4.462-3.948-4.882-.265-.049-.54-.074-.818-.074-.278 0-.553.025-.818.074h-.096zm.866 1.442c1.659.303 2.948 1.745 2.948 3.44 0 1.933-1.567 3.5-3.5 3.5s-3.5-1.567-3.5-3.5c0-1.695 1.289-3.137 2.948-3.44h1.104z"/>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8 0-1.85.63-3.55 1.69-4.9C7.06 5.79 9.37 5 12 5s4.94.79 6.31 2.1C19.37 8.45 20 10.15 20 12c0 4.41-3.59 8-8 8z"/>
    <path d="M12 5.5c-1.24 0-2.4.35-3.36.96C7.68 7.07 7 8.46 7 10c0 .55.45 1 1 1s1-.45 1-1c0-1.1.4-2.1 1.06-2.86.66-.76 1.54-1.14 2.44-1.14.9 0 1.78.38 2.44 1.14.66.76 1.06 1.76 1.06 2.86 0 .55.45 1 1 1s1-.45 1-1c0-1.54-.68-2.93-1.64-3.54C14.4 5.85 13.24 5.5 12 5.5z"/>
  </svg>
);
