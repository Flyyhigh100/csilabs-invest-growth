  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4 max-w-full mx-auto">
      ...
      <div className="space-y-3">
        <div className="text-gray-600 text-sm sm:text-base font-medium">Blockchain Contracts:</div>
        {tokenInfo ? (
          tokenInfo.blockchains.map((blockchain, index) => (
            <div key={index} className="p-2 sm:p-3 bg-gray-50 rounded-lg">
              <div className="flex justify-between mb-1">
                <span className="text-gray-600 text-sm sm:text-base">{blockchain.name}:</span>
              </div>
