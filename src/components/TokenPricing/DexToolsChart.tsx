...
const DexToolsChart: React.FC = () => {
  ...
  return <Card className="w-full h-[500px] overflow-hidden">
      <CardContent className="p-0 h-full relative">
        <iframe title="DexTools Chart" src={`https://www.dextools.io/widget-chart/en/polygon/pe-light/${poolAddress}?theme=light&chartType=1&chartResolution=1D&drawingToolbars=false`} className="w-full h-full border-0" allow="clipboard-write" referrerPolicy="no-referrer" sandbox="allow-scripts allow-same-origin allow-popups" />
