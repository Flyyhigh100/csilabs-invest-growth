...
const DexToolsChart: React.FC = () => {
  ...
  return <Card className="w-full overflow-hidden">
      ...
      <CardContent className="p-0 h-full relative">
        <iframe title="DexTools Chart" src={`https://www.dextools.io/widget-chart/en/polygon/pe-light/${poolAddress}?theme=light&chartType=1&chartResolution=1D&drawingToolbars=false`} className="w-full h-[400px] sm:h-[450px] md:h-[500px] border-0" allow="clipboard-write" referrerPolicy="no-referrer" sandbox="allow-scripts allow-same-origin allow-popups" />
